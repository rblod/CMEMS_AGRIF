...
MODULE global
   ...
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_url="$URL: svn+ssh://rblod@forge.ipsl.jussieu.fr/ipsl/forge/projets/nemo/svn/utils/tools_dev_r12970_AGRIF_CMEMS/SIREN/src/global.f90 $"    !< svn url
