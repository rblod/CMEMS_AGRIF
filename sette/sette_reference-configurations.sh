...
## Restartability tests for GYRE_PISCES
    ...
    sync_config  GYRE_PISCES GYRE_PISCES_ST 'cfgs'
    clean_config GYRE_PISCES GYRE_PISCES_ST 'cfgs'
    #
...
## Restartability tests for ORCA2_ICE_PISCES
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  ORCA2_ICE_PISCES ORCA2_ICE_PISCES_ST 'cfgs'
    clean_config ORCA2_ICE_PISCES ORCA2_ICE_PISCES_ST 'cfgs'
    #
...
## Restartability tests for ORCA2_OFF_PISCES
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  ORCA2_OFF_PISCES ORCA2_OFF_PISCES_ST 'cfgs'
    clean_config ORCA2_OFF_PISCES ORCA2_OFF_PISCES_ST 'cfgs'
    #
...
if [ ${config} == "AMM12" ] ;  then
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  AMM12 AMM12_ST 'cfgs'
    clean_config AMM12 AMM12_ST 'cfgs'
    #
...
## Restartability tests
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  ORCA2_SAS_ICE ORCA2_SAS_ICE_ST 'cfgs'
    clean_config ORCA2_SAS_ICE ORCA2_SAS_ICE_ST 'cfgs'
    #
...
## Reproducibility tests
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  ORCA2_ICE_PISCES ORCA2_ICE_OBS_ST 'cfgs'
    clean_config ORCA2_ICE_PISCES ORCA2_ICE_OBS_ST 'cfgs'
    #
...
## Restartability tests
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  AGRIF_DEMO AGRIF_DEMO_ST 'cfgs'
    clean_config AGRIF_DEMO AGRIF_DEMO_ST 'cfgs'
    #
...
if [ ${config} == "AGRIF" ] ;  then
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  AGRIF_DEMO AGRIF_DEMO_NOAGRIF_ST 'cfgs'
...
## Restartability tests
    ...
    # syncronisation if target directory/file exist (not done by makenemo)
    . ${SETTE_DIR}/all_functions.sh
    sync_config  SPITZ12 SPITZ12_ST 'cfgs'
    clean_config SPITZ12 SPITZ12_ST 'cfgs'
    #
